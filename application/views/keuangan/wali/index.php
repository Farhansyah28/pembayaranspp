                ...
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                    ...
                    <td class="px-6 py-4">
                        <div class="flex flex-wrap gap-2">
                            ...
                            <?php else: ?>
                                <span class="text-xs text-gray-400 py-1.5">Lunas</span>
                            <?php endif; ?>

                            <a href="<?= base_url('keuangan/wali/edit/' . $w->id) ?>"
                                class="text-white bg-blue-600 hover:bg-blue-700 font-medium rounded-lg text-xs px-3 py-1.5 focus:outline-none"
                                title="Edit Wali">
                                Edit
                            </a>
                            <a href="<?= base_url('keuangan/wali/delete/' . $w->id) ?>"
                                class="text-white bg-red-600 hover:bg-red-700 font-medium rounded-lg text-xs px-3 py-1.5 focus:outline-none confirm-action"
                                data-title="Hapus Wali Santri?" data-text="Akun login wali ini juga akan dihapus!"
                                data-confirm-text="Ya, Hapus!" title="Hapus Wali">
                                Hapus
                            </a>
                        </div>
                    </td>
