...
<h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-6">Tambah Wali Santri</h2>

<div class="max-w-4xl p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
    <form action="<?= base_url('keuangan/wali/store') ?>" method="POST">
        ...
        <div class="grid gap-6 mb-6 md:grid-cols-2">
            ...
            <div>
                ...
                <input type="text" id="username" name="username" value="<?= set_value('username') ?>"
                    ...
                    placeholder="wali_nama" required>
                <?= form_error('username', '<p class="mt-2 text-sm text-red-600">', '</p>') ?>
            </div>
            <div>
                <label for="password"
            ...
            <div>
                <label for="no_hp" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">No HP /
                    WhatsApp</label>
                <input type="text" id="no_hp" name="no_hp" value="<?= set_value('no_hp') ?>"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white"
            ...
            <div class="col-span-2">
                ...
                <textarea id="alamat" name="alamat" rows="3"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white"><?= set_value('alamat') ?></textarea>
            </div>
        </div>

        <div class="flex items-center space-x-4">
            <button type="submit"
                class="text-white bg-blue-700 hover:bg-blue-800 font-medium rounded-lg text-sm px-5 py-2.5">Simpan
                Data</button>
            <a href="<?= base_url('keuangan/wali') ?>"
