...
<h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-6">Tambah Santri</h2>

<div class="max-w-4xl p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
    <form action="<?= base_url('keuangan/santri/store') ?>" method="POST">
        ...
        <div class="grid gap-6 mb-6 md:grid-cols-2">
            ...
            <div>
                ...
                <?= form_error('kelas_id', '<p class="mt-2 text-sm text-red-600">', '</p>') ?>
            </div>
            <div>
                ...
                <select id="angkatan_id" name="angkatan_id"
                    ...
                    <?php foreach ($angkatan as $a): ?>
                        <option value="<?= $a->id ?>" <?= set_select('angkatan_id', $a->id) ?>>
                            <?= $a->nama ?>
                        </option>
                    <?php endforeach; ?>
                </select>
            ...
            <div>
                ...
                <select id="wali_user_id" name="wali_user_id"
                    ...
                    <?php foreach ($wali as $w): ?>
                        <option value="<?= $w->id ?>" <?= set_select('wali_user_id', $w->id) ?>>
                            <?= $w->nama ?>
                        </option>
                    <?php endforeach; ?>
                </select>
