            ...
            <?php foreach ($tahun_ajaran as $t): ?>
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                    ...
                    <td class="px-6 py-4">
                        ...
                        <?php else: ?>
                            <span
                                class="bg-gray-100 text-gray-800 text-xs font-medium px-2.5 py-0.5 rounded dark:bg-gray-700 dark:text-gray-300">Tidak
                                Aktif</span>
                        <?php endif; ?>
                    </td>
                    <td class="px-6 py-4">
                        <div class="flex items-center space-x-3">
                            <?php if (!$t->aktif): ?>
                                <a href="<?= base_url('admin/master/tahun_ajaran_aktifkan/' . $t->id) ?>"
                                    class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Aktifkan</a>
                                <a href="<?= base_url('admin/master/tahun_ajaran_delete/' . $t->id) ?>"
                                    class="font-medium text-red-600 dark:text-red-500 hover:underline confirm-action"
                                    data-title="Hapus Tahun Ajaran?"
                                    data-text="Menghapus tahun ajaran akan menghapus tarif terkait!"
