...
<h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-6">Tambah Pengguna Baru</h2>
        ...
        <div class="grid gap-6 mb-6 md:grid-cols-1">
            <div>
                ...
                <input type="text" id="username" name="username" value="<?= set_value('username') ?>"
                    ...
                    placeholder="admin_baru" required>
                <?= form_error('username', '<p class="mt-2 text-sm text-red-600 dark:text-red-500">', '</p>') ?>
            </div>
            <div>
                <label for="password"
