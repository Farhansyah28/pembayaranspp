            ...
            <?php if ($role == 'SUPER_ADMIN'): ?>
                ...
                <li>
                    <a href="<?= base_url('admin/maintenance') ?>"
                        class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group transition-all">
                        ...
                        <span class="ml-3">Maintenance Storage</span>
                        <span
                            class="inline-flex items-center justify-center px-2 ml-3 text-xs font-medium text-amber-800 bg-amber-100 rounded-full dark:bg-amber-900 dark:text-amber-300">Beta</span>
                    </a>
                </li>
            <?php endif; ?>
        </ul>
